                ...
                <svg width="140" height="40" viewBox="0 0 140 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g clipPath="url(#clip0_3182_1798)">
                        <g clipPath="url(#clip1_3182_1798)">
                            <path
                                ...
                                fill="var(--surface-0)"
                            />
                            <path d="M27 18.3653C10.5114 19.1945 0 8.88896 0 8.88896C0 8.88896 16.5176 14.5866 27 14.5866C37.4824 14.5866 54 8.88896 54 8.88896C54 8.88896 43.4886 17.5361 27 18.3653Z" fill="var(--surface-0)" />
                        </g>
                        <path
                    ...
                    <defs>
                        <clipPath id="clip0_3182_1798">
                            <rect width="140" height="40" fill="var(--surface-0)" />
                        </clipPath>
                        <clipPath id="clip1_3182_1798">
                            <rect width="54" height="40" fill="var(--surface-0)" />
                        </clipPath>
                    </defs>
                </svg>
            </template>
