                        ...
                        <div class="col-12 lg:col-4">
                            <div class="p-3 h-full">
                                <div class="shadow-2 p-5 flex flex-column surface-card" style="border-radius: 6px">
                                    ...
                                    <hr class="mb-3 mx-0 border-top-1 border-none surface-border" />
                                    <a href="mailto:contact@primetek.com.tr" v-ripple class="bg-bluegray-500 text-white hover:bg-bluegray-400 p-3 w-full border-round text-center transition-colors transition-duration-300 font-bold p-ripple"
                                        >Contact Us</a
                                    >
                                </div>
                            </div>
