<template>
    <div>
        <div class="flex flex-col xl:flex-row mb-8 gap-8">
            <div class="card flex-1 !m-0 relative overflow-hidden">
                ...
                <p class="m-0 leading-normal relative text-lg">
                    ...
                    <a href="https://discord.gg/gzKFYnpmCY" class="doc-link" target="_blank" rel="noopener noreferrer">Discord</a> are where the community users gather to seek support, post topics and discuss the technology. GitHub issue tracker is
                    the channel where community users can create tickets however PrimeTek does not guarantee a response time although they are monitored and maintained by our staff. If you need to secure a response, you may consider PRO support
                    instead.
                </p>
            </div>
            ...
            <div class="card !m-0 col-span-2">
                ...
                <ul class="flex flex-col gap-4 list-none m-0 p-0 text-lg">
                    ...
                    <li>
                        ...
                        <span class="leading-normal">Create a ticket using the exclusive private issue tracker with a description of the issue.</span>
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        <span class="leading-normal"
                            >If the issue requires an updated in the library, it gets published to npm by as part of the public PrimeVue package. A patch update on an older version can also be requested if you are not using the latest version.
                        </span>
                    </li>
                </ul>
            </div>
        ...
        <div class="card !mb-8">
            ...
            <div class="border-t border-surface pt-4 flex flex-col items-center">
                <p class="m-0 leading-normal mb-8 text-lg">
