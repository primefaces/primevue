<template>
    <div>
        ...
        <ClientOnly><AppDoc name="TreeTableResponsiveDemo" :sources="sources" :service="['NodeService']" :data="['treetablenodes']" github="treetable/TreeTableResponsiveDemo.vue" /></ClientOnly>
    </div>
</template>
