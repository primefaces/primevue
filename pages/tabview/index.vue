<template>
    <DocComponent title="Vue Tabs Component" header="TabView"
        description="TabView is a container component to group content with tabs." :componentDocs="docs"
        :apiDocs="['TabView', 'TabPanel']" :ptTabComponent="ptComponent" :themingDocs="themingDoc" />
</template>
