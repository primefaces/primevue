...
<template>
    <div>
        ...
        <Paginator template="PrevPageLink PageLinks NextPageLink RowsPerPageDropdown CurrentPageReport" :rows="10" :totalRecords="totalRecord:rowsPerPageOptions="[10, 20, 30]">
        ...
        <Paginator template="RowsPerPageDropdown CurrentPageReport PrevPageLink NextPageLink" :rows="10" :totalRecords="totalRecord:rowsPerPageOptions="[10, 20, 30]" class="justify-content-end my-3">
        ...
        <Paginator template="RowsPerPageDropdown PrevPageLink PageLinks NextPageLink CurrentPageReport" :rows="10" :totalRecords="totalRecord:rowsPerPageOptions="[10, 20, 30]" class="justify-content-start my-3">
            <template #RowsPerPageDropdown="{ options }">
...
export default {
    setup() {
        ...
        return { first, totalRecords, totalRecords2, reset , setPageLinks, dropdownOptions, onPageInputKeyDown };
    }
}
<\\/script>
