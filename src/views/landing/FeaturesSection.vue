<template>
    <section class="landing-features py-8">
        ...
        <div class="grid mt-7 pad-section" :style="{backgroundImage:`url('demo/images/landing-new/wave-${$appState.darkTheme ? 'dark-alt' : 'light-alt'}.svg')`, backgroundSize:'cover'}">
            ...
            <div class="col-12 md:col-6 xl:col-3 flex justify-content-center p-3">
                <div class="box p-4 w-full">
                    <img src="demo/images/landing-new/features/icon-community.svg" alt="components icon" class="block mb-3"/>
            ...
            <div class="col-12 md:col-6 xl:col-3 flex justify-content-center p-3">
                <div class="box p-4 w-full">
                    <img src="demo/images/landing-new/features/icon-productivity.svg" alt="components icon" class="block mb-3"/>
            ...
            <div class="col-12 md:col-6 xl:col-3 flex justify-content-center p-3">
                <div class="box p-4 w-full">
                    <img src="demo/images/landing-new/features/icon-support.svg" alt="components icon" class="block mb-3"/>
            ...
            <div class="col-12 md:col-6 xl:col-3 flex justify-content-center p-3">
                <div class="box p-4 w-full">
                    <img src="demo/images/landing-new/features/icon-mobile.svg" alt="components icon" class="block mb-3"/>
            ...
            <div class="col-12 md:col-6 xl:col-3 flex justify-content-center p-3">
                <div class="box p-4 w-full">
                    <img src="demo/images/landing-new/features/icon-theme.svg" alt="components icon" class="block mb-3"/>
            ...
            <div class="col-12 md:col-6 xl:col-3 flex justify-content-center p-3">
                <div class="box p-4 w-full">
                    <img src="demo/images/landing-new/features/icon-ts.svg" alt="components icon" class="block mb-3"/>
