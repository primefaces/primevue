...
export default {
    setup() {
        ...
        return { displayBasic, displayBasic2, displayModal, displayResponsive, displayConfirmation, displayMaximizable,
            ...
            openModal, closeModal, openConfirmation, closeConfirmation, openMaximizable, closeMaximizable, openPosition, closePosition, onHide}
    }
}
<\\/script>
...
.p-dialog .p-button {
    min-width: 6rem;
                ...
                'browser-source': {
                    ...
                    content: `<div id="app">
                <h5>Basic</h5>
                <p-button label="Show" icon="pi pi-external-link" @click="openBasic($event)" />
                <p-dialog v-model:visible="displayBasic" @hide="onHide" header="Header" :breakpoints="{ '960px': '75vw', '640px': '90vw' }" :style="{ width: '50vw' }">
                    <p>
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo
                        consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.
                    </p>
                    <template #footer>
                        <p-button label="No" icon="pi pi-times" @click="closeBasic" class="p-button-text" />
                        <p-button label="Yes" icon="pi pi-check" @click="closeBasic" autofocus />
                    </template>
                </p-dialog>

                <p-button label="Long Content" icon="pi pi-external-link" @click="openBasic2($event)" />
                <p-dialog v-model:visible="displayBasic2" @hide="onHide" header="Header" :breakpoints="{ '960px': '75vw', '640px': '90vw' }" :style="{ width: '50vw' }">
                    <p>
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo
                        consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.
                    </p>
                    ...
                    <template #footer>
                        <p-button label="No" icon="pi pi-times" @click="closeBasic2" class="p-button-text" />
                        <p-button label="Yes" icon="pi pi-check" @click="closeBasic2" autofocus />
                    </template>
                </p-dialog>

                <h5>Modal</h5>
                <p-button label="Show" icon="pi pi-external-link" @click="openModal" />
                <p-dialog v-model:visible="displayModal" @hide="onHide" header="Header" :breakpoints="{ '960px': '75vw', '640px': '90vw' }" :style="{ width: '50vw' }" :modal="true">
                    <p class="m-0">
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo
                        consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.
                    </p>
                    <template #footer>
                        <p-button label="No" icon="pi pi-times" @click="closeModal" class="p-button-text" />
                        <p-button label="Yes" icon="pi pi-check" @click="closeModal" autofocus />
                    </template>
                </p-dialog>

                <h5>Responsive</h5>
                <p-button label="Show" icon="pi pi-external-link" @click="openResponsive($event)" />
                <p-dialog v-model:visible="displayResponsive" @hide="onHide" header="Header" :breakpoints="{ '960px': '75vw', '640px': '90vw' }" :style="{ width: '50vw' }">
                    <p>
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo
                        consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.
                    </p>
                    <template #footer>
                        <p-button label="No" icon="pi pi-times" @click="closeResponsive" class="p-button-text" />
                        <p-button label="Yes" icon="pi pi-check" @click="closeResponsive" autofocus />
                    </template>
                </p-dialog>

                <h5>Confirmation</h5>
                <p-button label="Confirm" icon="pi pi-external-link" @click="openConfirmation($event)" />
                <p-dialog v-model:visible="displayConfirmation" @hide="onHide" header="Confirmation" :breakpoints="{ '960px': '75vw', '640px': '90vw' }" :style="{ width: '350px' }" :modal="true">
                    <div class="confirmation-content">
                        <i class="pi pi-exclamation-triangle mr-3" style="font-size: 2rem" />
                        <span>Are you sure you want to proceed?</span>
                    </div>
                    <template #footer>
                        <p-button label="No" icon="pi pi-times" @click="closeConfirmation" class="p-button-text" />
                        <p-button label="Yes" icon="pi pi-check" @click="closeConfirmation" class="p-button-text" autofocus />
                    </template>
                </p-dialog>

                <h5>Maximizable</h5>
                <p-button label="Show" icon="pi pi-external-link" @click="openMaximizable" />
                <p-dialog v-model:visible="displayMaximizable" @hide="onHide" header="Header" :breakpoints="{ '960px': '75vw', '640px': '90vw' }" :style="{ width: '50vw' }" :maximizable="true" :modal="true">
                    <p class="m-0">
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo
                        consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.
                    </p>
                    <template #footer>
                        <p-button label="No" icon="pi pi-times" @click="closeMaximizable" class="p-button-text" />
                        <p-button label="Yes" icon="pi pi-check" @click="closeMaximizable" autofocus />
                    </template>
                </p-dialog>
                ...
                <div class="grid flex-column">
                    <div class="col">
                        <p-button label="Left" icon="pi pi-arrow-right" @click="openPosition($event, 'left')" class="p-button-warning" />
                        <p-button label="Right" icon="pi pi-arrow-left" @click="openPosition($event, 'right')" class="p-button-warning" />
                    </div>
                    <div class="col">
                        <p-button label="Top" icon="pi pi-arrow-down" @click="openPosition($event, 'top')" class="p-button-warning" />
                        <p-button label="TopLeft" icon="pi pi-arrow-down-right" @click="openPosition($event, 'topleft')" class="p-button-warning" />
                        <p-button label="TopRight" icon="pi pi-arrow-down-left" @click="openPosition($event, 'topright')" class="p-button-warning" />
                    </div>
                    <div class="col">
                        <p-button label="Bottom" icon="pi pi-arrow-up" @click="openPosition($event, 'bottom')" class="p-button-warning" />
                        <p-button label="BottomLeft" icon="pi pi-arrow-up-right" @click="openPosition($event, 'bottomleft')" class="p-button-warning" />
                        <p-button label="BottomRight" icon="pi pi-arrow-up-left" @click="openPosition($event, 'bottomright')" class="p-button-warning" />
                    </div>
                </div>

                <p-dialog v-model:visible="displayPosition" @hide="onHide" header="Header" :breakpoints="{ '960px': '75vw', '640px': '90vw' }" :style="{ width: '50vw' }" :position="position" :modal="true">
                    <p class="m-0">
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo
                        consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.
                    </p>
                    <template #footer>
                        <p-button label="No" icon="pi pi-times" @click="closePosition" class="p-button-text" />
                        <p-button label="Yes" icon="pi pi-check" @click="closePosition" autofocus />
                    </template>
                </p-dialog>
        </div>
