<template>
    <div :class="containerClass" :style="style">
        ...
        <PVSButton type="button" class="p-splitbutton-menubutton" :icon="{ commonIcon: 'chevron-down', context: 'SplitButton' }" @click="onDropdownButtonClick" :disabled="$attrs.disabled"
