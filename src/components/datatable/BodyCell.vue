  ...
  >
    ...
    <template v-else-if="columnProp('selectionMode')">
      <DTRadioButton
        :value="rowData"
        :checked="selected"
        @change="toggleRowWithRadio"
        v-if="column.props.selectionMode === 'single'"
      />
      <DTCheckbox
        :value="rowData"
        :checked="selected"
        @change="toggleRowWithCheckbox"
        v-else-if="column.props.selectionMode === 'multiple'"
      />
    </template>
  ...
  methods: {
    columnProp(prop) {
      return this.column.props
        ? this.column.type.props[prop].type === Boolean &&
          this.column.props[prop] === ""
          ? true
          : this.column.props[prop]
        : null;
    },
