<template>
    <div class="app-demoactions p-d-flex p-ai-end p-jc-end p-mt-3">
        ...
        <Button :icon="{commonIcon: 'github', context: 'AppDemoActions' }" class="p-button-text p-button-rounded p-button-plain p-button-lg p-ml-2" @click="viewOnGitHub"></Button>
        <Button :icon="{commonIcon: 'info-circle', context: 'AppDemoActions' }" class="p-button-text p-button-rounded p-button-plain p-button-lg p-ml-2" @click="scrollToDocs"></Button>
