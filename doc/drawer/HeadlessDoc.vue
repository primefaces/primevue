            ...
            <template #container="{ closeCallback }">
                <div class="flex flex-col h-full">
                        ...
                        <ul class="list-none p-4 m-0">
                            <li>
                                <div
                                    ...
                                    class="p-4 flex items-center justify-between text-surface-600 cursor-pointer p-ripple"
                                >
                                ...
                                <ul class="list-none p-0 m-0 overflow-hidden">
                                    ...
                                    <li>
                                        <a
                                            ...
                                            class="flex items-center cursor-pointer p-4 rounded text-surface-700 hover:bg-surface-100 duration-150 transition-colors p-ripple"
                                        >
                    ...
                    <div class="mt-auto">
                        ...
                        <a v-ripple class="m-4 flex items-center cursor-pointer p-4 gap-2 rounded text-surface-700 hover:bg-surface-100 duration-150 transition-colors p-ripple">
