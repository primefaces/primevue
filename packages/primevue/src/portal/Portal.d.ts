import type { EmitFn, GlobalComponentConstructor, HintedString } from '@primevue/core';
...
declare const Portal: GlobalComponentConstructor<PortalProps, PortalSlots, PortalEmits>;
