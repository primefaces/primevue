...
import type { Theme as ThemeSingleton, dt as dtSingleton } from '@primeuix/styled';
...
export declare const getBaseStyleInstance: (Theme: typeof ThemeSingleton, dt: typeof dtSingleton) => BaseStyle;
