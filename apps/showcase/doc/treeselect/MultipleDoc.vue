<template>
    ...
    <div class="card flex justify-center">
        <TreeSelect v-model="selectedValue" :options="nodes" selectionMode="multiple" placeholder="Select Items" display="chip" class="md:w-80 w-full" />
    </div>
...
`
            ...
            code: {
                basic: `
<TreeSelect v-model="selectedValue" :options="nodes" selectionMode="multiple" placeholder="Select Item" display="chip" class="md:w-80 w-full" />
`,
                options: `
<template>
    <div class="card flex justify-center">
