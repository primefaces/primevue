<template>
    <DocSectionText v-bind="$attrs">
        ...
        <p>When using a custom container, you can use the <i>initDragCallback</i> to enable dragging functionality on a specific element.</p>
    </DocSectionText>
        ...
        <Dialog v-model:visible="visible" pt:root:class="!border-0 !bg-transparent" pt:mask:class="backdrop-blur-sm">
            <template #container="{ closeCallback, initDragCallback }">
                <div class="flex flex-col px-8 py-8 gap-6 rounded-2xl" style="background-image: radial-gradient(circle at left top, var(--p-primary-400), var(--p-primary-700))">
                    <svg width="35" height="40" viewBox="0 0 35 40" fill="none" xmlns="http://www.w3.org/2000/svg" @mousedown="initDragCallback" class="block mx-auto cursor-move">
                        <path
