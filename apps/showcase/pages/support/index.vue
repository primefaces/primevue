        ...
        <div class="card !mb-8">
            ...
            <div class="border-t border-surface pt-8 flex flex-col items-center">
                <p class="leading-normal mb-8 text-lg">
                    We are proud to collaborate with <a href="https://www.epicmax.co/contacts" target="_blank" rel="noopener noreferrer" class="doc-link">EpicMax</a> and
                    <a href="https://virtua.tech" target="_blank" rel="noopener noreferrer">Virtua</a> that share our commitment to excellence and open source values.
                </p>
                ...
                <div class="flex items-center gap-20">
                    ...
                    <div class="flex flex-col gap-4 items-center">
                        <a href="https://virtua.tech" target="_blank" rel="noopener noreferrer">
                            <svg width="76" height="24" viewBox="0 0 191 45" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <a href="https://virtua.tech/contact" class="inline-block bg-primary rounded-border py-3 px-4 hover:bg-primary-emphasis transition-all duration-300 text-primary-contrast font-semibold text-lg leading-none"> Get a Quote </a>
                    </div>
                </div>
            </div>
        </div>
