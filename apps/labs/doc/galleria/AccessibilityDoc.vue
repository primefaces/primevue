<template>
    <DocSectionText id="accessibility" label="Accessibility" v-bind="$attrs">
        ...
        <p>
            ...
            <i>aria-label</i> attribute of a quick navigation item refers to the <i>aria.pageLabel</i> of the <a href="https://primevue.org/configuration/#locale" target="_blank" rel="noopener noreferrer">locale</a> API. Current page is marked with
            <i>aria-current</i>.
        </p>
