<template>
    <DocSectionText id="accessibility" label="Accessibility" v-bind="$attrs">
        ...
        <p>
            ...
            <a href="https://primevue.org/configuration/#locale" target="_blank" rel="noopener noreferrer">locale</a> API by default, with <i>previewButtonProps</i>
        ...
        <p>
            ...
            <a href="https://primevue.org/configuration/#locale" target="_blank" rel="noopener noreferrer">locale</a> API as <i>aria-label</i>.
        </p>
