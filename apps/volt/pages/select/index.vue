<template>
    <DocComponent title="Vue Select Component" header="Select" description="Select is used to choose an item from a collection of options." :componentDocs="docs" />
</template>
...
import DownloadDoc from '@/doc/select/DownloadDoc.vue';
