<template>
    <DocSectionText v-bind="$attrs">
        <p>
            Volt requires Tailwind CSS v4+ for theming. The prerequisite steps are covered by the
            <a href="https://tailwindcss.com/docs/installation/framework-guides/nuxt" target="_blank" rel="noopener noreferrer">Install Tailwind CSS with Nuxt</a> guide. If you have Vite and Tailwind configured successfully, follow the next steps.
        </p>
        <p>
