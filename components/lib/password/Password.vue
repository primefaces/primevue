<template>
    <div :class="cx('root')" :style="sx('root')" v-bind="ptmi('root')">
        ...
        <slot v-if="toggleMask && unmasked" name="hideicon" :onClick="onMaskToggle" :toggleCallback="onMaskToggle">
            <component :is="hideIcon ? 'i' : 'EyeSlashIcon'" :class="[cx('hideIcon'), hideIcon]" @click="onMaskToggle" v-bind="ptm('hideIcon')" @keypress="onToggleMaskKeyDown" tabindex="0" :aria-label="$primevue.config.locale.aria.passwordHide" />
        </slot>
        <slot v-if="toggleMask && !unmasked" name="showicon" :onClick="onMaskToggle" :toggleCallback="onMaskToggle">
            <component :is="showIcon ? 'i' : 'EyeIcon'" :class="[cx('showIcon'), showIcon]" @click="onMaskToggle" v-bind="ptm('showIcon')" @keypress="onToggleMaskKeyDown" tabindex="0" :aria-label="$primevue.config.locale.aria.passwordShow" />
        </slot>
