...
export interface PrimeIconsOptions {
    ...
    readonly SORT_DOWN_FILL: string;
    ...
    readonly SORT_UP_FILL: string;
    readonly SPARKLES: string;
    readonly SPINNER: string;
    readonly SPINNER_DOWN: string;
